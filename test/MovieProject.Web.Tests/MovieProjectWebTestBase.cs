...
{
    public abstract class MovieProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MovieProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MovieProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MovieProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MovieProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MovieProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MovieProjectDbContext, Task<T>> func)
        {
            T result;
